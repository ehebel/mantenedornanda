# Django settings for mantenedornanda project.
import os
gettext = lambda s: s
...
#        'NAME': os.path.join(PROJECT_PATH, 'modeladorCASdb'),                      # Or path to database file if using sqlite3.
        'NAME': os.path.join(PROJECT_PATH, 'mantnandadb'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '2xlm1qp)skl$%9dj)7-vt%=ar96r6eh)d$9i%m5*zjb)4-al#@'
...
ROOT_URLCONF = 'mantenedornanda.urls'
