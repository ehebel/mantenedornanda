...
from mantenedornanda.mantnocapp.models import noc, nocClase, nocDominio, nocEscala, nocEspecialidad, nocIndicador, relacionNandaNoc, relacionNicNoc
...
admin.site.register(relacionNicNoc)
